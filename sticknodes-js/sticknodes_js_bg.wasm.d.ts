...
export const node_local_x: (a: number) => number;
export const node_set_local_x: (a: number, b: number) => void;
export const node_local_y: (a: number) => number;
export const node_set_local_y: (a: number, b: number) => void;
...
export const node_right_triangle_direction: (a: number) => number;
export const node_set_right_triangle_direction: (a: number, b: number) => void;
export const node_triangle_upside_down: (a: number) => number;
export const node_set_triangle_upside_down: (a: number, b: number) => void;
export const node_trapezoid_top_thickness_ratio: (a: number) => number;
export const node_set_trapezoid_top_thickness_ratio: (a: number, b: number) => void;
