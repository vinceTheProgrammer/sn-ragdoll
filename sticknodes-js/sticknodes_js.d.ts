...
export class Polyfill {
   ...
   */
  try_remove_attached_node_draw_indices(draw_indices: Int32Array): Int32Array;
  readonly stickfigure: Stickfigure;
  readonly id: number;
  readonly anchor_node_draw_index: number;
  color: Color;
  use_polyfill_color: boolean;
  readonly attached_node_draw_indices: Int32Array;
}
export class Stickfigure {
   ...
   */
  constructor();
  static from_bytes(bytes: Uint8Array): Stickfigure;
  to_bytes(): Uint8Array;
  set_version(version_code: number): void;
  to_jsobject(): any;
  add_polyfill(options: any): Polyfill;
  get_polyfill(anchor_draw_index: number): Polyfill;
  get_all_polyfills(): Polyfill[];
  get_node(draw_index: number): Node;
  get_nodes(draw_indices: Uint32Array): Node[];
  get_all_node_indices(): Uint32Array;
  get_all_nodes(): Node[];
  readonly id: number;
